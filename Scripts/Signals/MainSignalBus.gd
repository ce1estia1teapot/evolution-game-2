...
signal health_component_value_changed(p_reporting_entity: Entity, p_health_component: HealthComponent, p_old_health: float, p_new_health: float)
## To be called by an Entity when its health component's health reaches 0
signal health_component_died(p_reporting_entity: Entity, p_health_component: HealthComponent)
